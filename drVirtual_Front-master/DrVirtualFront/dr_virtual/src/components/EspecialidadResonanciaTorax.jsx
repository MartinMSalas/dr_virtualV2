...
import ResonanciaToraxMenu from './ResonanciaToraxMenu'
export default function EspecialidadResonanciaTorax ({clickHandler, especialidadPadre}) {
  ...
  return (
    <>
      ...
      <ResonanciaToraxMenu clickHandler={especialidadHandler}></ResonanciaToraxMenu>
