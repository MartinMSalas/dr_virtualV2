...
import ResonanciaCraneoMenu from './ResonanciaCraneoMenu'

export default function EspecialidadResonanciaCraneo ({clickHandler, especialidadPadre}) {
  ...
  return (
    <>
      ...
      <ResonanciaCraneoMenu clickHandler={especialidadHandler}></ResonanciaCraneoMenu>
