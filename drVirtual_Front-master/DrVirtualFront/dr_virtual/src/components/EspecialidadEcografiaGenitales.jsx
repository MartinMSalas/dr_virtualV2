...
import EcografiaGenitalesMenu from './EcografiaGenitalesMenu'
import { FormBasico3 } from './FormBasico3'
import ObraSocial2 from './ObraSocial2'
import ApiMeli from './ApiMeli'

export default function EspecialidadEcografiaGenitales ({clickHandler}) {
  ...
  return (
    <>
      ...
      <EcografiaGenitalesMenu clickHandler={especialidadHandler}></EcografiaGenitalesMenu>
