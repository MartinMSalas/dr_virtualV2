...
import TomografiaAbdomenMenu from './TomografiaAbdomenMenu'
export default function EspecialidadTomografiaAbdomen ({clickHandler, especialidadPadre}) {
  ...
  return (
    <>
      ...
      <TomografiaAbdomenMenu clickHandler={especialidadHandler}></TomografiaAbdomenMenu>
      {especialidadClick && <ObraSocial2 clickHandler={clickHandlerObraSocial}></ObraSocial2>}
      {obraSocialClick && (<FormBasico3 formHandler={formHandler} obraSocialSelected={obraSocialSelected} especialidadSelected={`Tomografia A.C. de ${especialidadSelected}`}></FormBasico3>)}
